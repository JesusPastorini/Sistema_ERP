...
namespace ControleEstoque.Migrations
{
    ...
    [Migration("20260516033559_AtualizaMovimentacaoEstoque")]
    partial class AtualizaMovimentacaoEstoque
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleEstoque.Models.EntradaEstoque", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_entradas_estoque");

                    b.HasIndex("FornecedorId")
                        .HasDatabaseName("ix_entradas_estoque_fornecedor_id");

                    b.ToTable("entradas_estoque", (string)null);
                });

            modelBuilder.Entity("ControleEstoque.Models.EntradaEstoqueItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("EntradaEstoqueId")
                        .HasColumnType("integer")
                        .HasColumnName("entrada_estoque_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_entrada_estoque_itens");

                    b.HasIndex("EntradaEstoqueId")
                        .HasDatabaseName("ix_entrada_estoque_itens_entrada_estoque_id");

                    b.HasIndex("ProdutoId")
                        .HasDatabaseName("ix_entrada_estoque_itens_produto_id");

                    b.ToTable("entrada_estoque_itens", (string)null);
                });
            ...
            modelBuilder.Entity("ControleEstoque.Models.EntradaEstoque", b =>
                {
                    b.HasOne("Fornecedor", "Fornecedor")
                        .WithMany()
                        .HasForeignKey("FornecedorId")
                        .HasConstraintName("fk_entradas_estoque_fornecedores_fornecedor_id");
            ...
            modelBuilder.Entity("ControleEstoque.Models.EntradaEstoqueItem", b =>
                {
                    b.HasOne("ControleEstoque.Models.EntradaEstoque", "EntradaEstoque")
                        .WithMany("Itens")
                        .HasForeignKey("EntradaEstoqueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_entrada_estoque_itens_entradas_estoque_entrada_estoque_id");
                    ...
                    b.HasOne("Produto", "Produto")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_entrada_estoque_itens_produtos_produto_id");
